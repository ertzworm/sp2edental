        ...
        appointmentsTable  = appointments.map(appointment =>{
            ...
            return(
                <Table.Row key={appointment.id}>
                    ...
                    <Table.Cell>{appointment.lastName}, {appointment.firstName} </Table.Cell>
                    <Table.Cell>
                    
                       <DeleteAppointmentLink item={appointment}></DeleteAppointmentLink>
					...
					<Grid.Column width={12}>
                        ...
                        <Accordion fluid styled>
                            <Accordion.Title active={activeIndex === 0} index={0} onClick={this.handleClick}>
                                <Icon name="dropdown"></Icon>Information
                            </Accordion.Title>
                            ...
                            <Accordion.Title active={activeIndex === 1} index={1} onClick={this.handleClick}>
                                <Icon name="dropdown"></Icon>Appointments
                            </Accordion.Title>
