...
import {Container, Icon, Accordion, Card, Image, Button} from 'semantic-ui-react';
                ...
                <Container>
                    ...
                    <Accordion fluid styled>
                        <Accordion.Title active={activeIndex === 0} index={0} onClick={this.handleClick}>
                            <Icon name="dropdown"></Icon>Pending Users
                        </Accordion.Title>
                        ...
                        <Card.Group centered itemsPerRow={4}>
                            <Card>
                                <Card.Content>
                                    ...
                                    <Card.Meta>Nurse <Icon name="zoom-in"></Icon></Card.Meta>
                                    <Card.Description>
                            ...
                            <Card>
                                <Card.Content>
                                    ...
                                    <Card.Meta>Doctor <Icon name="zoom-in"></Icon></Card.Meta>
                                    <Card.Description>
                        ...
                        <Accordion.Title active={activeIndex === 1} index={1} onClick={this.handleClick}>
                            <Icon name="dropdown"></Icon>Active Users
                        </Accordion.Title>
