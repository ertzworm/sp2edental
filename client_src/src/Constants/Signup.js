    ...
    render() {
      ...
      return (
        <div>
          ...
          <Button onClick={this.show('blurring')} color="blue" inverted>Sign Up</Button>
                    ...
                    <Modal.Content>
                        <Form>
                            ...
                            <Form.Group widths="equal">
                                ...
                                <Form.Input onChange={this.handleChange} value={this.state.password} name="password" type="password" fluid label="Password" placeholder="Password"></Form.Input>
                            </Form.Group>
