                    ...
                    <Modal.Content>
                        <Form>
                            ...
                            <Form.Group>
                                ...
                                <Form.Input onChange={this.handleChange} value={this.state.civilStatus} name="civilStatus" type="text" label="Civil Status" placeholder="Civil Status" />
                            </Form.Group>

                            <Form.Group widths="equal">
                                
                                <Form.Input onChange={this.handleChange} value={this.state.occupation} name="occupation" type="text" fluid label="Occupation" placeholder="Occupation"></Form.Input>
