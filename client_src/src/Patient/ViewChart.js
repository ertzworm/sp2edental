    ...
    render(){
        ...
        return(
            ...
            <Modal size={size} dimmer={dimmer} open={open} onClose={this.close}>
                            ...
                            <Container text-align="center">
                                ...
                                <h2> Upper Teeth </h2>    
                                    {this.state.upperteeth.map((item, index) => (
                                        ...
                                        <Button disabled key={index} circular color={colorGuide[item]} onClick={()=> this.onUpdateItemUpperTeeth(index)} >{index}</Button>
                                    ))}
                                ...
                                <Divider></Divider>
                                    ...
                                    {this.state.lowerteeth.map((item, index) => (
                                        ...
                                        <Button disabled key={index} circular color={colorGuide[item]} onClick={()=> this.onUpdateItemLowerTeeth(index)}>{index}</Button>
                    ...
                    <Modal.Actions>
                        <Link to={"/tabs/patients/view/" +patientId} className="ui button positive">Return</Link>
                    </Modal.Actions>
                </Modal>
