                    ...
                    <Modal.Description>
                        <Form>
                            <Form.Group widths="equal">
                                ...
                                <Form.Input onChange={this.handleChange} value={this.state.prescription} label="Prescription" name="prescription" type="text" placeholder="Prescription" ref="prescription"></Form.Input>
                            </Form.Group>
