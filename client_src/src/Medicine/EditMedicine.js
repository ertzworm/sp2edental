                    ...
                    <Modal.Description>
                        <Form>
                            <Form.Group widths="equal">
                                <Form.Input onChange={this.handleChange} label="Generic Name" name="genericName" value={this.state.genericName} type="text" placeholder="Generic Name" ref="genericName"></Form.Input>
                                <Form.Input onChange={this.handleChange} label="Brand Name" name="brandName" value={this.state.brandName} type="text" placeholder="Brand Name" ref="brandName"></Form.Input>
                                <Form.Input onChange={this.handleChange} label="Quantity" name="quantity" value={this.state.quantity} type="text" placeholder="Quantity Name" ref="quantity"></Form.Input>
                            </Form.Group>
